...
function ProcessRow({ step, index }: { step: Step; index: number }) {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 py-12 md:grid-cols-[auto_1fr] md:gap-20 md:py-16">
        {/* Giant step number */}
        <div className="mb-3 md:mb-0 md:w-64 lg:w-80">
          <span
            className="block font-mono font-black leading-[0.85] text-border transition-colors duration-500 group-hover:text-violet-500/25"
